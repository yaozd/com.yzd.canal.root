package com.yzd.example2.h5.utils.cookieExt;

import com.yzd.example2.h5.utils.encryptExt.EncryptAESUtil;
import com.yzd.example2.h5.utils.settingExt.ProjectSetting;
...
public class CookieUtil {
    ...
    public void addCookie(String name, String value,int expireSeconds) {
        if(value!=null)
        {
            value= EncryptAESUtil.toEncrypt(value);
        }
        ...
        cookies.setMaxAge(expireSeconds);
    ...
    public String getCookieValue(String cookieName) {
        if (cookieName != null) {
            ...
            if (cookie != null) {
                ...
                return EncryptAESUtil.toDecrypt(cookieValue);
            }
        }
        return "";
    }
